...
function archive.masonry.dev.publish ()
{
    ...
    curl "http://external7.ddns.peelvalley.com.au:8080/api/v0/get?arg=${dev_versions_cid}" > /dev/null
    ...
    curl "http://io2.phillm.net:8080/api/v0/get?arg=${dev_versions_cid}" > /dev/null
    ...
    curl "http://192.168.42.208:8080/api/v0/get?arg=${dev_versions_cid}" > /dev/null
    ...
    curl "https://api.vps1.ipfs-archive.online/api/v0/get?arg=${dev_versions_cid}" > /dev/null
    ...
    curl "https://api.vps2.ipfs-archive.online/api/v0/get?arg=${dev_versions_cid}" > /dev/null
    ...
    curl "https://api.vps3.ipfs-archive.online/api/v0/get?arg=${dev_versions_cid}" > /dev/null
    ...
    curl "https://api1.ipfs-archive.online/api/v0/get?arg=${dev_versions_cid}" > /dev/null
    ...
    curl --user 'user:rrVfzbvRYTwNABCxJWjeHFu4' "https://vps4.phillm.net/api/v0/get?arg=${dev_versions_cid}" > /dev/null
    ...
    curl --user 'user:rrVfzbvRYTwNABCxJWjeHFu4' "https://rhea.phillm.net/api/v0/get?arg=${dev_versions_cid}" > /dev/null
    ...
    curl "https://api.vps5.ipfs-archive.online/api/v0/get?arg=${dev_versions_cid}" > /dev/null
