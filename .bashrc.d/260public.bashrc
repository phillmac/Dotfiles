...
function public.list.preload ()
{
    ...
    echo "$(date) VPS3          $(wc -l < <(IPFS_HTTP_GATEWAY=https://vps3.phillm.net   ipfs.ls.recursive "${cid}" 2> /dev/null | tee vps3.public.preload.log.txt))"   > vps4.public.preload.count.txt   &
